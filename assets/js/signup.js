...
nameUser.addEventListener('keyup', () => {
  if(nameUser.value.length <= 2){
    ...
    labelName.innerHTML = 'Name minimun 3 characters'
    nameUser.setAttribute('style', 'border-color: red')
    validName = false
  } else {
    labelName.setAttribute('style', 'color: green')
    labelName.innerHTML = 'Name'
    nameUser.setAttribute('style', 'border-color: green')
    validNome = true
  }
})
...
usuario.addEventListener('keyup', () => {
  if(usuario.value.length <= 4){
    ...
    labelUsuario.innerHTML = 'User minimun 5 characters'
...
senha.addEventListener('keyup', () => {
  if(senha.value.length <= 5){
    ...
    labelSenha.innerHTML = 'Password *Insira no minimo 6 caracteres'
